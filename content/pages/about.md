...
![](/images/blog/2018/08/computer-electronics-768x510.jpg)
...
Engineering embedded systems in a small- to mid-sized company sometimes means, that you are the only guy that understands the systems in a whole, especially, if your company's main business is not the development of embedded systems. If you do not addict to clean code and good documentation, anybody that will follow you is totally lost, even if it is you, not touching the project for some weeks. Not even thinking about having an accident, retiring or leaving the company.
...
Additionally, I'll document my private projects, just in case I want to get up to speed again, when I need to dig into it years later and also to spread the knowledge on how to solve common problems with electronics, firmware, software,... just tindering...

## The Nickname

Just in case, anybody wonders about my nickname "themole". During my university time, I was one of the IT administrators of the dormitory I lived in. Since the university blocked most of the traffic in both directions, one of my hobbies soon got SSH-tunneling. I really got experienced in chaining SSH tunnels and even faking DNS entries to make applications working through the tunnels… Soon the IT team called me "Der Maulwurf" which is simply the german word for that little digging animal. Surely, tunneling diggs security holes, but an experienced digger knows how to keep the static integrity of an IT building or even enforces it by such tunnels ;-)
