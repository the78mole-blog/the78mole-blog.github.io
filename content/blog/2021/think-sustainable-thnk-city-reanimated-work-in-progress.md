...
- [Arndt's Blog - Mein Think, wie alles begann](https://arndt-barop.info/2018/11/30/mein-think-city-wie-alles-begann/)
...
To tackle the problem, we will first collect some data about the battery and the individual cells without damaging too much of it all. After disassembling the battery to inidividual modules, we need to get access to the single cells (in fact to the 2p-pairs). Measuring the connector pins and looking at some photos of [Arndt's blog](https://arndt-barop.info/2018/11/30/mein-think-city-wie-alles-begann/), we identified the correct pins. A1-A11, B1-B10, A18-A21 and B18-B21 are potential candidates for the thermistors/NTCs. This arises from the pictures of the cell connection foils from Arndt's blog.
