...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    // --- Tag-Archivseiten ---
    '/tag/thnk-city':               { redirect: '/' },
    '/tag/thnk-city/':              { redirect: '/' },
    '/tag/open-semantic-search':    { redirect: '/' },
    '/tag/open-semantic-search/':   { redirect: '/' },
    '/tag/ssl':                     { redirect: '/' },
    '/tag/ssl/':                    { redirect: '/' },
    '/tag/bash':                    { redirect: '/' },
    '/tag/bash/':                   { redirect: '/' },
    '/tag/cluster':                 { redirect: '/' },
    '/tag/cluster/':                { redirect: '/' },
    '/tag/influxdb':                { redirect: '/' },
    '/tag/influxdb/':               { redirect: '/' },
    '/tag/hal':                     { redirect: '/' },
    '/tag/hal/':                    { redirect: '/' },
    '/tag/hal/feed':                { redirect: '/' },
    '/tag/hal/feed/':               { redirect: '/' },
    '/tag/compressed-archives':     { redirect: '/' },
    '/tag/compressed-archives/':    { redirect: '/' },
    '/tag/stromboerse':             { redirect: '/' },
    '/tag/stromboerse/':            { redirect: '/' },
    '/tag/sml':                     { redirect: '/' },
    '/tag/sml/':                    { redirect: '/' },
    '/tag/pio':                     { redirect: '/' },
    '/tag/pio/':                    { redirect: '/' },
    '/tag/pio/feed':                { redirect: '/' },
    '/tag/pio/feed/':               { redirect: '/' },
    '/tag/soil':                    { redirect: '/' },
    '/tag/soil/':                   { redirect: '/' },
    '/tag/dtu':                     { redirect: '/' },
    '/tag/dtu/':                    { redirect: '/' },
    '/tag/dtu/feed':                { redirect: '/' },
    '/tag/dtu/feed/':               { redirect: '/' },
    '/tag/usb':                     { redirect: '/' },
    '/tag/usb/':                    { redirect: '/' },
    '/tag/market-data':             { redirect: '/' },
    '/tag/market-data/':            { redirect: '/' },
    '/tag/run-time-analysis':       { redirect: '/' },
    '/tag/run-time-analysis/':      { redirect: '/' },
    '/tag/electric-vehicle':        { redirect: '/' },
    '/tag/electric-vehicle/':       { redirect: '/' },
    '/tag/rd6006':                  { redirect: '/' },
    '/tag/rd6006/':                 { redirect: '/' },
    '/tag/rd6006/feed':             { redirect: '/' },
    '/tag/rd6006/feed/':            { redirect: '/' },
    '/tag/mbus':                    { redirect: '/' },
    '/tag/mbus/':                   { redirect: '/' },
    '/tag/isolated-modbus':         { redirect: '/' },
    '/tag/isolated-modbus/':        { redirect: '/' },
    '/tag/isolated-modbus/feed':    { redirect: '/' },
    '/tag/isolated-modbus/feed/':   { redirect: '/' },
    '/tag/add-on-repository':       { redirect: '/' },
    '/tag/add-on-repository/':      { redirect: '/' },
    '/tag/rd6012':                  { redirect: '/' },
    '/tag/rd6012/':                 { redirect: '/' },
    '/tag/rd6012/feed':             { redirect: '/' },
    '/tag/rd6012/feed/':            { redirect: '/' },
    '/tag/debugging':               { redirect: '/' },
    '/tag/debugging/':              { redirect: '/' },
    '/tag/km200':                   { redirect: '/' },
    '/tag/km200/':                  { redirect: '/' },
    '/tag/km200/feed':              { redirect: '/' },
    '/tag/km200/feed/':             { redirect: '/' },
    '/tag/pm2204':                  { redirect: '/' },
    '/tag/pm2204/':                 { redirect: '/' },
    '/tag/nodered':                 { redirect: '/' },
    '/tag/nodered/':                { redirect: '/' },
    '/tag/bldc':                    { redirect: '/' },
    '/tag/bldc/':                   { redirect: '/' },
    '/tag/bldc/feed':               { redirect: '/' },
    '/tag/bldc/feed/':              { redirect: '/' },
    '/tag/exip':                    { redirect: '/' },
    '/tag/exip/':                   { redirect: '/' },
    '/tag/ultrasonic':              { redirect: '/' },
    '/tag/ultrasonic/':             { redirect: '/' },
    '/tag/electric-car':            { redirect: '/' },
    '/tag/electric-car/':           { redirect: '/' },
    '/tag/bootloader':              { redirect: '/' },
    '/tag/bootloader/':             { redirect: '/' },
    '/tag/touch-controller':        { redirect: '/' },
    '/tag/touch-controller/':       { redirect: '/' },
    '/tag/olimex':                  { redirect: '/' },
    '/tag/olimex/':                 { redirect: '/' },
    '/tag/olimex/feed':             { redirect: '/' },
    '/tag/olimex/feed/':            { redirect: '/' },
    '/tag/vscode':                  { redirect: '/' },
    '/tag/vscode/':                 { redirect: '/' },
    '/tag/stm32cubeide':            { redirect: '/' },
    '/tag/stm32cubeide/':           { redirect: '/' },
    '/tag/penmount':                { redirect: '/' },
    '/tag/penmount/':               { redirect: '/' },
    '/tag/stm32':                   { redirect: '/' },
    '/tag/stm32/':                  { redirect: '/' },
    '/tag/stm32/feed':              { redirect: '/' },
    '/tag/stm32/feed/':             { redirect: '/' },
    '/tag/iobroker':                { redirect: '/' },
    '/tag/iobroker/':               { redirect: '/' },
    '/tag/iobroker/feed':           { redirect: '/' },
    '/tag/iobroker/feed/':          { redirect: '/' },
    '/tag/touch-screen':            { redirect: '/' },
    '/tag/touch-screen/':           { redirect: '/' },
    '/tag/odroid-hc4':              { redirect: '/' },
    '/tag/odroid-hc4/':             { redirect: '/' },
    '/tag/opensemanticsearch':      { redirect: '/' },
    '/tag/opensemanticsearch/':     { redirect: '/' },
    '/tag/m-bus':                   { redirect: '/' },
    '/tag/m-bus/':                  { redirect: '/' },
    '/tag/codenotary':              { redirect: '/' },
    '/tag/codenotary/':             { redirect: '/' },

    // --- Kategorie-Archivseiten ---
    '/category/laboratory':                       { redirect: '/' },
    '/category/laboratory/':                      { redirect: '/' },
    '/category/tibber':                           { redirect: '/' },
    '/category/tibber/':                          { redirect: '/' },
    '/category/tibber/feed':                      { redirect: '/' },
    '/category/tibber/feed/':                     { redirect: '/' },
    '/category/renewable-energy/solar-energy':    { redirect: '/' },
    '/category/renewable-energy/solar-energy/':   { redirect: '/' },
    '/category/esp32/esphome':                    { redirect: '/' },
    '/category/esp32/esphome/':                   { redirect: '/' },
    '/category/esp32/esphome/feed':               { redirect: '/' },
    '/category/esp32/esphome/feed/':              { redirect: '/' },
    '/category/esp32':                            { redirect: '/' },
    '/category/esp32/':                           { redirect: '/' },
    '/category/esp32/feed':                       { redirect: '/' },
    '/category/esp32/feed/':                      { redirect: '/' },
    '/category/smart-home/page/2':                { redirect: '/' },
    '/category/smart-home/page/2/':               { redirect: '/' },
    '/category/general':                          { redirect: '/' },
    '/category/general/':                         { redirect: '/' },
    '/category/freertos':                         { redirect: '/' },
    '/category/freertos/':                        { redirect: '/' },
    '/category/arm/page/2':                       { redirect: '/' },
    '/category/arm/page/2/':                      { redirect: '/' },
    '/category/tools/atlassian':                  { redirect: '/' },
    '/category/tools/atlassian/':                 { redirect: '/' },
    '/category/smart-home/node-red':              { redirect: '/' },
    '/category/smart-home/node-red/':             { redirect: '/' },
    '/category/bus-systems/modbus':               { redirect: '/' },
    '/category/bus-systems/modbus/':              { redirect: '/' },
    '/category/bus-systems/modbus/feed':          { redirect: '/' },
    '/category/bus-systems/modbus/feed/':         { redirect: '/' },
    '/category/stm32/motor-control':              { redirect: '/' },
    '/category/stm32/motor-control/':             { redirect: '/' },
    '/category/corona-virus':                     { redirect: '/' },
    '/category/corona-virus/':                    { redirect: '/' },
    '/category/uncategorized/page/2':             { redirect: '/' },
    '/category/uncategorized/page/2/':            { redirect: '/' },
